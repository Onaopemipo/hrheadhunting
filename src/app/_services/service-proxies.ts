...
export class AccountServiceProxy {
    ...
    consultantSignUp(body: ManageConsultantDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Account/ConsultantSignUp";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processConsultantSignUp(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processConsultantSignUp(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processConsultantSignUp(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    changePassword(body: ChangePasswordDTO | undefined): Observable<MessageOutApiResult> {
...
export class ApplicantServiceProxy {
    ...
    /**
     * API to update an Applicant's Profile
     * @param body (optional) 
     * @return Success
     */
    updateMyProfile(body: ManageJobSeekerRegDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Applicant/UpdateMyProfile";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateMyProfile(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateMyProfile(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API to add/update an Applicant's Qualification to update Profile
     * @param body (optional) 
     * @return Success
     */
    addUpdateQualification(body: ManageJobSeekerQualificationDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Applicant/AddUpdateQualification";
        url_ = url_.replace(/[?&]$/, "");
    ...
    /**
     * API for getting Applicant's Education Histories Listing with filter but optional
     * @param pageSize (optional) 
     * @param pageNumber (optional) 
     * @return Success
     */
    fetchMyEducations(pageSize: number | undefined, pageNumber: number | undefined): Observable<JobSeekerEducationIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/FetchMyEducations?";
        if (pageSize === null)
            throw new Error("The parameter 'pageSize' cannot be null.");
        else if (pageSize !== undefined)
            url_ += "pageSize=" + encodeURIComponent("" + pageSize) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchMyEducations(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchMyEducations(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerEducationIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerEducationIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchMyEducations(response: HttpResponseBase): Observable<JobSeekerEducationIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerEducationIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobSeekerEducationIListOdataResult>(<any>null);
    }

    /**
     * API to get Applicant Single Education/Qualification detail by Id and can be used for update, details etc
     * @param id (optional) 
     * @return Success
     */
    getEducationById(id: number | undefined): Observable<JobSeekerEducationOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/GetEducationById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetEducationById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetEducationById(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerEducationOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerEducationOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetEducationById(response: HttpResponseBase): Observable<JobSeekerEducationOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerEducationOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobSeekerEducationOdataResult>(<any>null);
    }
     ...
     * @return Success
     */
    deleteEducation(id: number | undefined): Observable<MessageOutOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/DeleteEducation?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteEducation(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteEducation(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<MessageOutOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processDeleteEducation(response: HttpResponseBase): Observable<MessageOutOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = MessageOutOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<MessageOutOdataResult>(<any>null);
    }

    /**
     * API to add/update an Applicant's Work Experience to update Profile
     * @param body (optional) 
     * @return Success
     */
    addUpdateWorkExperience(body: ManageJobSeekerExperienceDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Applicant/AddUpdateWorkExperience";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddUpdateWorkExperience(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddUpdateWorkExperience(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processAddUpdateWorkExperience(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting Applicant's Work Experience Histories with filter but optional
     * @param pageSize (optional) 
     * @param pageNumber (optional) 
     * @return Success
     */
    fetchMyWorkExperiences(pageSize: number | undefined, pageNumber: number | undefined): Observable<JobSeekerExperienceIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/FetchMyWorkExperiences?";
        if (pageSize === null)
            throw new Error("The parameter 'pageSize' cannot be null.");
        else if (pageSize !== undefined)
            url_ += "pageSize=" + encodeURIComponent("" + pageSize) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchMyWorkExperiences(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchMyWorkExperiences(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerExperienceIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerExperienceIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchMyWorkExperiences(response: HttpResponseBase): Observable<JobSeekerExperienceIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerExperienceIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobSeekerExperienceIListOdataResult>(<any>null);
    }

    /**
     * API to get Applicant Single Work Experience detail by Id and can be used for update, details etc
     * @param id (optional) 
     * @return Success
     */
    getWorkExperienceById(id: number | undefined): Observable<JobSeekerExperienceOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/GetWorkExperienceById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetWorkExperienceById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetWorkExperienceById(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerExperienceOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerExperienceOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetWorkExperienceById(response: HttpResponseBase): Observable<JobSeekerExperienceOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerExperienceOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobSeekerExperienceOdataResult>(<any>null);
    }
     ...
     * @return Success
     */
    deleteWorkExperience(id: number | undefined): Observable<MessageOutOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/DeleteWorkExperience?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteWorkExperience(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteWorkExperience(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteWorkExperience(response: HttpResponseBase): Observable<MessageOutOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API to update an Applicant's Job Preference Profile
     * @param body (optional) 
     * @return Success
     */
    updateJobPreference(body: ManageJobSeekerPreferenceDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Applicant/UpdateJobPreference";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processUpdateJobPreference(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateJobPreference(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processUpdateJobPreference(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API to get Applicant Job Preference detail and can be used for update, details etc
     * @return Success
     */
    getJobPreference(): Observable<ManageJobSeekerPreferenceDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/GetJobPreference";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetJobPreference(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetJobPreference(<any>response_);
                } catch (e) {
                    return <Observable<ManageJobSeekerPreferenceDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<ManageJobSeekerPreferenceDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetJobPreference(response: HttpResponseBase): Observable<ManageJobSeekerPreferenceDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ManageJobSeekerPreferenceDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ManageJobSeekerPreferenceDTOOdataResult>(<any>null);
    }

    /**
     * API to add an Applicant's Resume to update Profile
     * @param body (optional) 
     * @return Success
     */
    addResumes(body: ManageJobSeekerCVDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Applicant/AddResumes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddResumes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddResumes(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processAddResumes(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting Applicant's Resumes with filter but optional
     * @param pageSize (optional) 
     * @param pageNumber (optional) 
     * @return Success
     */
    fetchMyResumes(pageSize: number | undefined, pageNumber: number | undefined): Observable<JobSeekerResumeIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/FetchMyResumes?";
        if (pageSize === null)
            throw new Error("The parameter 'pageSize' cannot be null.");
        else if (pageSize !== undefined)
            url_ += "pageSize=" + encodeURIComponent("" + pageSize) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchMyResumes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchMyResumes(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerResumeIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerResumeIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchMyResumes(response: HttpResponseBase): Observable<JobSeekerResumeIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerResumeIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobSeekerResumeIListOdataResult>(<any>null);
    }

    /**
     * API to get Applicant Single Resume detail by Id and can be used for update, details etc
     * @param id (optional) 
     * @return Success
     */
    getResumeById(id: number | undefined): Observable<JobSeekerResumeOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/GetResumeById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetResumeById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetResumeById(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerResumeOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerResumeOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetResumeById(response: HttpResponseBase): Observable<JobSeekerResumeOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerResumeOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobSeekerResumeOdataResult>(<any>null);
    }
     ...
     * @return Success
     */
    deleteResume(id: number | undefined): Observable<MessageOutOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/DeleteResume?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteResume(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteResume(response: HttpResponseBase): Observable<MessageOutOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API to get Applicant details by Id and can be used for update, details etc
     * @return Success
     */
    getMyProfile(): Observable<ApplicantProfileDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/GetMyProfile";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<ApplicantProfileDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<ApplicantProfileDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetMyProfile(response: HttpResponseBase): Observable<ApplicantProfileDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ApplicantProfileDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<ApplicantProfileDTOOdataResult>(<any>null);
    }

    /**
     * API for getting Applicant Job's Application Listing with filter but optional
     ...
     * @return Success
     */
    fetchMyApplications(jobId: number | undefined, recruitmentStageId: number | undefined, searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<JobApplicationDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/FetchMyApplications?";
        if (jobId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchMyApplications(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchMyApplications(<any>response_);
                } catch (e) {
    ...
    protected processFetchMyApplications(response: HttpResponseBase): Observable<JobApplicationDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API to get Applicant Job Application details by ApplicationId
     * @param id (optional) 
     * @return Success
     */
    getApplicationDetail(id: number | undefined): Observable<JobApplicationDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Applicant/GetApplicationDetail?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetApplicationDetail(<any>response_);
                } catch (e) {
                    return <Observable<JobApplicationDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobApplicationDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetApplicationDetail(response: HttpResponseBase): Observable<JobApplicationDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobApplicationDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<JobApplicationDTOOdataResult>(<any>null);
    }
}
...
export class ApplicationsServiceProxy {
    ...
    fetchEmployerJobs(searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<JobDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applications/FetchEmployerJobs?";
        if (searchText !== undefined && searchText !== null)
            url_ += "SearchText=" + encodeURIComponent("" + searchText) + "&";
        if (dateFrom !== undefined && dateFrom !== null)
            url_ += "DateFrom=" + encodeURIComponent(dateFrom ? "" + dateFrom.toJSON() : "") + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchEmployerJobs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchEmployerJobs(<any>response_);
                } catch (e) {
    ...
    protected processFetchEmployerJobs(response: HttpResponseBase): Observable<JobDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    fetchJobApplications(jobId: number | undefined, recruitmentStageId: number | undefined, searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<JobApplicationDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applications/FetchJobApplications?";
        if (jobId === null)
            throw new Error("The parameter 'jobId' cannot be null.");
        else if (jobId !== undefined)
            url_ += "JobId=" + encodeURIComponent("" + jobId) + "&";
    ...
    protected processFetchJobApplications(response: HttpResponseBase): Observable<JobApplicationDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getJobApplicantById(id: number | undefined): Observable<JobSeekerDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Applications/GetJobApplicantById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetJobApplicantById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetJobApplicantById(<any>response_);
                } catch (e) {
                    return <Observable<JobSeekerDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<JobSeekerDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetJobApplicantById(response: HttpResponseBase): Observable<JobSeekerDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = JobSeekerDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    processApplication(body: ProcessApplicationDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Applications/ProcessApplication";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processProcessApplication(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting Applicant Application Log with filter but optional
    SearchText cover the followings; (Job Location (State/Country))
     * @param jobId (optional) 
     * @param recruitmentStageId (optional) 
     * @param searchText (optional) 
     * @param dateFrom (optional) 
     ...
     */
    fetchMyApplications(jobId: number | undefined, recruitmentStageId: number | undefined, searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<JobApplicationDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Applications/FetchMyApplications?";
        if (jobId === null)
            throw new Error("The parameter 'jobId' cannot be null.");
        else if (jobId !== undefined)
            url_ += "JobId=" + encodeURIComponent("" + jobId) + "&";
...
@Injectable()
export class ArtisanServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    addUpdateArtisan(body: ManageArtisanDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Artisan/AddUpdateArtisan";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processAddUpdateArtisan(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAddUpdateArtisan(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processAddUpdateArtisan(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    fetchAllArtisans(searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<ArtisanDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Artisan/FetchAllArtisans?";
        if (searchText !== undefined && searchText !== null)
            url_ += "SearchText=" + encodeURIComponent("" + searchText) + "&";
        if (dateFrom !== undefined && dateFrom !== null)
            url_ += "DateFrom=" + encodeURIComponent(dateFrom ? "" + dateFrom.toJSON() : "") + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchAllArtisans(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchAllArtisans(<any>response_);
                } catch (e) {
                    return <Observable<ArtisanDTOIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<ArtisanDTOIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchAllArtisans(response: HttpResponseBase): Observable<ArtisanDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ArtisanDTOIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    getArtisanById(id: number | undefined): Observable<ArtisanDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Artisan/GetArtisanById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetArtisanById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetArtisanById(<any>response_);
                } catch (e) {
                    return <Observable<ArtisanDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<ArtisanDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetArtisanById(response: HttpResponseBase): Observable<ArtisanDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = ArtisanDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
     ...
     * @return Success
     */
    deleteArtisan(id: number | undefined): Observable<MessageOutOdataResult> {
        let url_ = this.baseUrl + "/api/Artisan/DeleteArtisan?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processDeleteArtisan(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteArtisan(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteArtisan(response: HttpResponseBase): Observable<MessageOutOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CommonServiceProxy {
    ...
    /**
     * API for getting Duration Length Categories (e.g., Minute, Hour, Day etc) on the System for dropdowns
     * @return Success
     */
    fetchDurationLengths(): Observable<IDTextViewModelIListOdataResult> {
        let url_ = this.baseUrl + "/api/Common/FetchDurationLengths";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchDurationLengths(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchDurationLengths(<any>response_);
                } catch (e) {
    ...
    protected processFetchDurationLengths(response: HttpResponseBase): Observable<IDTextViewModelIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting Recruitment Stages on the System for dropdowns
     * @return Success
     */
    ...
    /**
     * API for getting Genders on the System for dropdowns
     * @return Success
     */
    fetchGenders(): Observable<IDTextViewModelIListOdataResult> {
        let url_ = this.baseUrl + "/api/Common/FetchGenders";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchGenders(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchGenders(<any>response_);
                } catch (e) {
                    return <Observable<IDTextViewModelIListOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFetchGenders(response: HttpResponseBase): Observable<IDTextViewModelIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting All Employers on the System for dropdowns
     * @return Success
     */
...
@Injectable()
export class ConsultantServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * API for getting All Active Training Listing with filter but optional
     * @param searchText (optional) 
     * @param dateFrom (optional) 
     * @param dateTo (optional) 
     * @param pageSize (optional) 
     ...
     * @return Success
     */
    fetchActiveTrainings(searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<TrainingDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Consultant/FetchActiveTrainings?";
        if (searchText !== undefined && searchText !== null)
            url_ += "SearchText=" + encodeURIComponent("" + searchText) + "&";
        if (dateFrom !== undefined && dateFrom !== null)
            url_ += "DateFrom=" + encodeURIComponent(dateFrom ? "" + dateFrom.toJSON() : "") + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchActiveTrainings(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchActiveTrainings(<any>response_);
                } catch (e) {
                    return <Observable<TrainingDTOIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<TrainingDTOIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchActiveTrainings(response: HttpResponseBase): Observable<TrainingDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TrainingDTOIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TrainingDTOIListOdataResult>(<any>null);
    }

    /**
     * API to get Training by id and can be used for update, details etc
     * @param id (optional) 
     * @return Success
     */
    fetchTrainingById(id: number | undefined): Observable<TrainingDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Consultant/FetchTrainingById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchTrainingById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchTrainingById(<any>response_);
                } catch (e) {
                    return <Observable<TrainingDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<TrainingDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchTrainingById(response: HttpResponseBase): Observable<TrainingDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = TrainingDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<TrainingDTOOdataResult>(<any>null);
    }

    /**
     * API for posting Training Application by Anonymous User on the Portal
     * @param body (optional) 
     * @return Success
     */
    postTrainingApplication(body: TrainingApplicantDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Consultant/PostTrainingApplication";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processPostTrainingApplication(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processPostTrainingApplication(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processPostTrainingApplication(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    postTraining(body: ManageTrainingDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Consultant/PostTraining";
        url_ = url_.replace(/[?&]$/, "");
    ...
    protected processPostTraining(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class CountriesServiceProxy {
    ...
    /**
     * API for getting All Countries for dropdowns
     * @return Success
     */
...
export class CourseServiceProxy {
    ...
    /**
     * API for getting All Courses for dropdowns
     * @return Success
     */
...
export class CurrenciesServiceProxy {
    ...
    /**
     * API for getting All Currencies for dropdowns
     * @return Success
     */
...
@Injectable()
export class CvScoreServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    /**
     * API to analyze CV Scoring
     * @param body (optional) 
     * @return Success
     */
    analyze(body: CvScoreDTO | undefined): Observable<RezScoreApiResult> {
        let url_ = this.baseUrl + "/api/CvScore/Analyze";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processAnalyze(<any>response_);
                } catch (e) {
                    return <Observable<RezScoreApiResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<RezScoreApiResult>><any>_observableThrow(response_);
        }));
    }

    protected processAnalyze(response: HttpResponseBase): Observable<RezScoreApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = RezScoreApiResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<RezScoreApiResult>(<any>null);
    }
}
...
@Injectable()
export class EmployerServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
    ...
    fetchAllEmployers(sectorId: number | undefined, stateId: number | undefined, isNewlyAdded: boolean | undefined, isPopular: boolean | undefined, searchText: string | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<EmployerDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Employer/FetchAllEmployers?";
        if (sectorId === null)
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    ...
                    return <Observable<EmployerDTOIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<EmployerDTOIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchAllEmployers(response: HttpResponseBase): Observable<EmployerDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EmployerDTOIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    getEmployerById(id: number | undefined): Observable<EmployerDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Employer/GetEmployerById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processGetEmployerById(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetEmployerById(<any>response_);
                } catch (e) {
                    return <Observable<EmployerDTOOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<EmployerDTOOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processGetEmployerById(response: HttpResponseBase): Observable<EmployerDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = EmployerDTOOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
...
export class EmployerTypesServiceProxy {
    ...
    /**
     * API for getting All EmployerTypes for dropdowns
     * @return Success
     */
...
export class GradesServiceProxy {
    ...
    /**
     * API for getting All Grades for dropdowns
     * @return Success
     */
...
export class InstitutionServiceProxy {
    ...
    /**
     * API for getting All Institutions for dropdowns
     * @return Success
     */
...
export class JobServiceProxy {
     ...
     * @return Success
     */
    postJob(body: ManageJobDTO | undefined): Observable<MessageOutApiResult> {
    ...
    fetchJobs(companyId: number | undefined, skillAreaId: number | undefined, countryId: number | undefined, stateId: number | undefined, isNewlyAdded: boolean | undefined, isPopular: boolean | undefined, searchText: string | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<JobDTOIListOdataResult> {
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchJobs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchJobs(<any>response_);
                } catch (e) {
                    return <Observable<JobDTOIListOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFetchJobs(response: HttpResponseBase): Observable<JobDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    getJobById(id: string | null | undefined): Observable<JobDTOOdataResult> {
     ...
     * @return Success
     */
    applyJob(jobId: string | null | undefined): Observable<MessageOutApiResult> {
...
export class JobTypesServiceProxy {
    ...
    /**
     * API for getting All JobTypes for dropdowns
     * @return Success
     */
...
export class PaymentServiceProxy {
    ...
    verifyEmployerPayment(reference: string | null | undefined, userId: string | null | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Payment/VerifyEmployerPayment?";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVerifyEmployerPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVerifyEmployerPayment(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVerifyEmployerPayment(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API to verify Applicant's Psychometric Test payment while setting up their account
     * @param reference (optional) 
     * @param userId (optional) 
     * @return Success
     */
    verifyPsychometricPayment(reference: string | null | undefined, userId: string | null | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Payment/VerifyPsychometricPayment?";
        if (reference !== undefined && reference !== null)
            url_ += "reference=" + encodeURIComponent("" + reference) + "&";
        if (userId !== undefined && userId !== null)
            url_ += "userId=" + encodeURIComponent("" + userId) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVerifyPsychometricPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVerifyPsychometricPayment(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVerifyPsychometricPayment(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    verifyTrainingPayment(reference: string | null | undefined, trainingId: string | null | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Payment/VerifyTrainingPayment?";
        if (reference !== undefined && reference !== null)
            url_ += "reference=" + encodeURIComponent("" + reference) + "&";
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processVerifyTrainingPayment(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processVerifyTrainingPayment(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processVerifyTrainingPayment(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting All Subscription's Payment Listing for
    Applicants Test subscription, Consultants training payment, Employer plan, and Training Subscription with filter but optional
    SearchText cover the followings; (Amount paid)
     * @param searchText (optional) 
     * @param dateFrom (optional) 
     * @param dateTo (optional) 
     * @param pageSize (optional) 
     ...
     * @return Success
     */
    fetchMySubscriptionPayments(searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<SubscriptionPaymentIListOdataResult> {
        let url_ = this.baseUrl + "/api/Payment/FetchMySubscriptionPayments?";
        if (searchText !== undefined && searchText !== null)
            url_ += "SearchText=" + encodeURIComponent("" + searchText) + "&";
        if (dateFrom !== undefined && dateFrom !== null)
            url_ += "DateFrom=" + encodeURIComponent(dateFrom ? "" + dateFrom.toJSON() : "") + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchMySubscriptionPayments(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchMySubscriptionPayments(<any>response_);
                } catch (e) {
                    return <Observable<SubscriptionPaymentIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<SubscriptionPaymentIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchMySubscriptionPayments(response: HttpResponseBase): Observable<SubscriptionPaymentIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SubscriptionPaymentIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
        ...
        return _observableOf<SubscriptionPaymentIListOdataResult>(<any>null);
    }
}
...
export class QualificationServiceProxy {
    ...
    /**
     * API for getting All Qualifications for dropdowns
     * @return Success
     */
...
export class QuizServiceProxy {
     ...
     * @return Success
     */
    fetchQuizTypes(): Observable<IDTextViewModelIListApiResult> {
        let url_ = this.baseUrl + "/api/Quiz/FetchQuizTypes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchQuizTypes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchQuizTypes(<any>response_);
                } catch (e) {
    ...
    protected processFetchQuizTypes(response: HttpResponseBase): Observable<IDTextViewModelIListApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    fetchQuestionTypes(): Observable<IDTextViewModelIListApiResult> {
        let url_ = this.baseUrl + "/api/Quiz/FetchQuestionTypes";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchQuestionTypes(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchQuestionTypes(<any>response_);
                } catch (e) {
                    return <Observable<IDTextViewModelIListApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFetchQuestionTypes(response: HttpResponseBase): Observable<IDTextViewModelIListApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    addUpdateQuiz(body: ManageQuizDTO | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Quiz/AddUpdateQuiz";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getAllQuizzes(): Observable<QuizDTOListApiResult> {
        let url_ = this.baseUrl + "/api/Quiz/GetAllQuizzes";
        url_ = url_.replace(/[?&]$/, "");
     ...
     * @return Success
     */
    getQuizById(id: number | undefined): Observable<QuizDTOApiResult> {
        let url_ = this.baseUrl + "/api/Quiz/GetQuizById?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processGetQuizById(<any>response_);
                } catch (e) {
    ...
    protected processGetQuizById(response: HttpResponseBase): Observable<QuizDTOApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
     ...
     * @return Success
     */
    deleteQuiz(id: number | undefined): Observable<MessageOutApiResult> {
        let url_ = this.baseUrl + "/api/Quiz/DeleteQuiz?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("delete", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processDeleteQuiz(<any>response_);
                } catch (e) {
                    return <Observable<MessageOutApiResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processDeleteQuiz(response: HttpResponseBase): Observable<MessageOutApiResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class ReportServiceProxy {
    ...
    fetchAllEmployers(searchText: string | null | undefined, dateFrom: Date | null | undefined, dateTo: Date | null | undefined, pageSize: number | undefined, pageNumber: number | undefined): Observable<EmployerDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Report/FetchAllEmployers?";
        if (searchText !== undefined && searchText !== null)
            url_ += "SearchText=" + encodeURIComponent("" + searchText) + "&";
        if (dateFrom !== undefined && dateFrom !== null)
            url_ += "DateFrom=" + encodeURIComponent(dateFrom ? "" + dateFrom.toJSON() : "") + "&";
...
export class RoleServiceProxy {
     ...
     * @return Success
     */
    fetchRoles(): Observable<ApplicationRoleDTOOdataResult> {
        let url_ = this.baseUrl + "/api/Role/FetchRoles";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchRoles(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchRoles(<any>response_);
                } catch (e) {
    ...
    protected processFetchRoles(response: HttpResponseBase): Observable<ApplicationRoleDTOOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class SectorsServiceProxy {
    ...
    /**
     * API for getting All Sectors for dropdowns
     * @return Success
     */
    ...
    /**
     * API for getting All Sectors with the number of Jobs posted under each for dropdowns
     * @return Success
     */
    fetchSectorJobs(): Observable<IDTextViewModelIListOdataResult> {
        let url_ = this.baseUrl + "/api/Sectors/FetchSectorJobs";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchSectorJobs(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchSectorJobs(<any>response_);
                } catch (e) {
                    return <Observable<IDTextViewModelIListOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFetchSectorJobs(response: HttpResponseBase): Observable<IDTextViewModelIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
...
export class SkillAreasServiceProxy {
    ...
    /**
     * API for getting All SkillAreas for dropdowns
     * @return Success
     */
...
export class StatesServiceProxy {
    ...
    fetchAllStateByCountry(id: number | undefined): Observable<StateIListOdataResult> {
        let url_ = this.baseUrl + "/api/States/FetchAllStateByCountry?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "id=" + encodeURIComponent("" + id) + "&";
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchAllStateByCountry(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchAllStateByCountry(<any>response_);
                } catch (e) {
                    return <Observable<StateIListOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFetchAllStateByCountry(response: HttpResponseBase): Observable<StateIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting All States for dropdowns
     * @return Success
     */
...
export class SubscriptionsServiceProxy {
    ...
    /**
     * API for getting All Recruiter's Subscription Plans and their respective Features for User selection on the Public Portal.
     * @return Success
     */
    fetchRecruiterPlanFeatures(): Observable<SubscriptionFeatureDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Subscriptions/FetchRecruiterPlanFeatures";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchRecruiterPlanFeatures(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchRecruiterPlanFeatures(<any>response_);
                } catch (e) {
                    return <Observable<SubscriptionFeatureDTOIListOdataResult>><any>_observableThrow(e);
                }
            } else
                return <Observable<SubscriptionFeatureDTOIListOdataResult>><any>_observableThrow(response_);
        }));
    }

    protected processFetchRecruiterPlanFeatures(response: HttpResponseBase): Observable<SubscriptionFeatureDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
        ...
        if (status === 200) {
            ...
            let result200: any = null;
            let resultData200 = _responseText === "" ? null : JSON.parse(_responseText, this.jsonParseReviver);
            result200 = SubscriptionFeatureDTOIListOdataResult.fromJS(resultData200);
            return _observableOf(result200);
            }));
        } else if (status === 400) {
            return blobToText(responseBlob).pipe(_observableMergeMap(_responseText => {
    ...
    /**
     * API for getting All CV-Rewrite's Subscription Plans and their respective Features for User selection on the Public Portal.
     * @return Success
     */
    fetchCvRewritePlanFeatures(): Observable<SubscriptionFeatureDTOIListOdataResult> {
        let url_ = this.baseUrl + "/api/Subscriptions/FetchCvRewritePlanFeatures";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("get", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processFetchCvRewritePlanFeatures(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processFetchCvRewritePlanFeatures(<any>response_);
                } catch (e) {
                    return <Observable<SubscriptionFeatureDTOIListOdataResult>><any>_observableThrow(e);
                }
            } else
    ...
    protected processFetchCvRewritePlanFeatures(response: HttpResponseBase): Observable<SubscriptionFeatureDTOIListOdataResult> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    /**
     * API for getting All Subscriptions for dropdowns
     * @return Success
     */
...
export class TitlesServiceProxy {
    ...
    /**
     * API for getting All Titles for dropdowns
     * @return Success
     */
...
export class ManageJobSeekerRegDTO implements IManageJobSeekerRegDTO {
    ...
    password!: string;
    isPsychometricSelected?: boolean;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.isPsychometricSelected = _data["isPsychometricSelected"];
    ...
    toJSON(data?: any) {
        ...
        data["isPsychometricSelected"] = this.isPsychometricSelected;
...
export class ManageEmployerDTO implements IManageEmployerDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.aboutCompany = _data["aboutCompany"];
            this.password = _data["password"];
...
export class ManageConsultantDTO implements IManageConsultantDTO {
    ...
    static fromJS(data: any): ManageConsultantDTO {
        data = typeof data === 'object' ? data : {};
...
export class VwUserObj implements IVwUserObj {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.profile_percent = _data["profile_percent"];
    ...
    toJSON(data?: any) {
        ...
        data["profile_percent"] = this.profile_percent;
...
export class ManageJobSeekerQualificationDTO implements IManageJobSeekerQualificationDTO {
    id?: number;
    qualificationId?: number;
    courseOfStudyId?: number;
    institutionId?: number;
    ...
    constructor(data?: IManageJobSeekerQualificationDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ManageJobSeekerQualificationDTO {
        data = typeof data === 'object' ? data : {};
        let result = new ManageJobSeekerQualificationDTO();
        result.init(data);
        return result;
    }
...
export interface IManageJobSeekerQualificationDTO {
    id?: number;
    qualificationId?: number;
    courseOfStudyId?: number;
    institutionId?: number;
...
export class JobSeekerEducation implements IJobSeekerEducation {
    ...
    static fromJS(data: any): JobSeekerEducation {
        data = typeof data === 'object' ? data : {};
...
export class JobSeekerEducationIListOdataResult implements IJobSeekerEducationIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerEducation[] | undefined;
    totalCount?: number;

    constructor(data?: IJobSeekerEducationIListOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                ...
                for (let item of _data["value"])
                    this.value!.push(JobSeekerEducation.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerEducationIListOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobSeekerEducationIListOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobSeekerEducationIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerEducation[] | undefined;
...
export class JobSeekerEducationOdataResult implements IJobSeekerEducationOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    ...
    constructor(data?: IJobSeekerEducationOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? JobSeekerEducation.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerEducationOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobSeekerEducationOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobSeekerEducationOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerEducation;
...
export class MessageOutOdataResult implements IMessageOutOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: MessageOut;
    ...
    constructor(data?: IMessageOutOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? MessageOut.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): MessageOutOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new MessageOutOdataResult();
        result.init(data);
        return result;
    }
...
export interface IMessageOutOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: MessageOut;
...
export class ManageJobSeekerExperienceDTO implements IManageJobSeekerExperienceDTO {
    id?: number;
    currentJobTitle?: string | undefined;
    companyName?: string | undefined;
    workStartDate?: Date;
    ...
    constructor(data?: IManageJobSeekerExperienceDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ManageJobSeekerExperienceDTO {
        data = typeof data === 'object' ? data : {};
        let result = new ManageJobSeekerExperienceDTO();
        result.init(data);
        return result;
    }
...
export interface IManageJobSeekerExperienceDTO {
    id?: number;
    currentJobTitle?: string | undefined;
    companyName?: string | undefined;
    workStartDate?: Date;
...
export class JobSeekerExperience implements IJobSeekerExperience {
    ...
    static fromJS(data: any): JobSeekerExperience {
        data = typeof data === 'object' ? data : {};
...
export class JobSeekerExperienceIListOdataResult implements IJobSeekerExperienceIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerExperience[] | undefined;
    totalCount?: number;

    constructor(data?: IJobSeekerExperienceIListOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(JobSeekerExperience.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerExperienceIListOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobSeekerExperienceIListOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobSeekerExperienceIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerExperience[] | undefined;
...
export class JobSeekerExperienceOdataResult implements IJobSeekerExperienceOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerExperience;
    totalCount?: number;

    constructor(data?: IJobSeekerExperienceOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? JobSeekerExperience.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerExperienceOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobSeekerExperienceOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobSeekerExperienceOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerExperience;
...
export class ManageJobSeekerPreferenceDTO implements IManageJobSeekerPreferenceDTO {
    id?: number;
    fieldOfInterestId?: number;
    stateOfInterestId?: number;
    yearOfExperience?: number;
    ...
    constructor(data?: IManageJobSeekerPreferenceDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ManageJobSeekerPreferenceDTO {
        data = typeof data === 'object' ? data : {};
        let result = new ManageJobSeekerPreferenceDTO();
        result.init(data);
        return result;
    }
...
export interface IManageJobSeekerPreferenceDTO {
    id?: number;
    fieldOfInterestId?: number;
    stateOfInterestId?: number;
    yearOfExperience?: number;
...
export class ManageJobSeekerPreferenceDTOOdataResult implements IManageJobSeekerPreferenceDTOOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: ManageJobSeekerPreferenceDTO;
    totalCount?: number;

    constructor(data?: IManageJobSeekerPreferenceDTOOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? ManageJobSeekerPreferenceDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ManageJobSeekerPreferenceDTOOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new ManageJobSeekerPreferenceDTOOdataResult();
        result.init(data);
        return result;
    }
...
export interface IManageJobSeekerPreferenceDTOOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: ManageJobSeekerPreferenceDTO;
...
export class ManageJobSeekerCVDTO implements IManageJobSeekerCVDTO {
    id?: number;
    resume?: string | undefined;
    videoResume?: string | undefined;

    constructor(data?: IManageJobSeekerCVDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ManageJobSeekerCVDTO {
        data = typeof data === 'object' ? data : {};
        let result = new ManageJobSeekerCVDTO();
        result.init(data);
        return result;
    }
...
export interface IManageJobSeekerCVDTO {
    id?: number;
    resume?: string | undefined;
    videoResume?: string | undefined;
}
...
export class JobSeekerResume implements IJobSeekerResume {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.registeredUserId = _data["registeredUserId"];
            this.cvResume = _data["cvResume"];
            this.videoResume = _data["videoResume"];
        }
    }

    static fromJS(data: any): JobSeekerResume {
        data = typeof data === 'object' ? data : {};
...
export class JobSeekerResumeIListOdataResult implements IJobSeekerResumeIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerResume[] | undefined;
    totalCount?: number;

    constructor(data?: IJobSeekerResumeIListOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(JobSeekerResume.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerResumeIListOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobSeekerResumeIListOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobSeekerResumeIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerResume[] | undefined;
...
export class JobSeekerResumeOdataResult implements IJobSeekerResumeOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerResume;
    totalCount?: number;

    constructor(data?: IJobSeekerResumeOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? JobSeekerResume.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerResumeOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobSeekerResumeOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobSeekerResumeOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobSeekerResume;
...
export class ApplicantProfileDTO implements IApplicantProfileDTO {
    id?: number;
    titleId?: number;
    firstName?: string | undefined;
    lastname?: string | undefined;
    ...
    constructor(data?: IApplicantProfileDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.stateOfInterest = _data["stateOfInterest"];
            this.nationality = _data["nationality"];
            this.jobApplicantRefCode = _data["jobApplicantRefCode"];
            this.age = _data["age"];
            ...
            if (Array.isArray(_data["educations"])) {
                ...
                for (let item of _data["educations"])
                    this.educations!.push(JobSeekerEducation.fromJS(item));
            }
            if (Array.isArray(_data["experiences"])) {
                this.experiences = [] as any;
                for (let item of _data["experiences"])
                    this.experiences!.push(JobSeekerExperience.fromJS(item));
            }
            if (Array.isArray(_data["resumes"])) {
                this.resumes = [] as any;
                for (let item of _data["resumes"])
                    this.resumes!.push(JobSeekerResume.fromJS(item));
            }
            this.resume = _data["resume"];
            this.videoResume = _data["videoResume"];
            this.briefDescription = _data["briefDescription"];
    ...
    static fromJS(data: any): ApplicantProfileDTO {
        data = typeof data === 'object' ? data : {};
        let result = new ApplicantProfileDTO();
        result.init(data);
        return result;
    }
    ...
    toJSON(data?: any) {
        ...
        data["stateOfInterest"] = this.stateOfInterest;
        data["nationality"] = this.nationality;
        data["jobApplicantRefCode"] = this.jobApplicantRefCode;
        data["age"] = this.age;
...
export class ApplicantProfileDTOOdataResult implements IApplicantProfileDTOOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: ApplicantProfileDTO;
    totalCount?: number;

    constructor(data?: IApplicantProfileDTOOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? ApplicantProfileDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ApplicantProfileDTOOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new ApplicantProfileDTOOdataResult();
        result.init(data);
        return result;
    }
...
export interface IApplicantProfileDTOOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: ApplicantProfileDTO;
...
export class JobApplicationDTOOdataResult implements IJobApplicationDTOOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobApplicationDTO;
    totalCount?: number;

    constructor(data?: IJobApplicationDTOOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? JobApplicationDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobApplicationDTOOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new JobApplicationDTOOdataResult();
        result.init(data);
        return result;
    }
...
export interface IJobApplicationDTOOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: JobApplicationDTO;
...
export class JobDTO implements IJobDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.jobCloseInDays = _data["jobCloseInDays"];
            this.totalCandidates = _data["totalCandidates"];
            this.ref = _data["ref"];
            this.dateCreated = _data["dateCreated"] ? new Date(_data["dateCreated"].toString()) : <any>undefined;
            this.isDeleted = _data["isDeleted"];
            this.isActive = _data["isActive"];
    ...
    toJSON(data?: any) {
        ...
        data["jobCloseInDays"] = this.jobCloseInDays;
        data["totalCandidates"] = this.totalCandidates;
        data["ref"] = this.ref;
        data["dateCreated"] = this.dateCreated ? this.dateCreated.toISOString() : <any>undefined;
        data["isDeleted"] = this.isDeleted;
        data["isActive"] = this.isActive;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(JobDTO.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobDTOIListOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class JobApplicationStage implements IJobApplicationStage {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.recruitmentStageId = _data["recruitmentStageId"];
            (<any>this).recruitmentStageName = _data["recruitmentStageName"];
        }
    }

    static fromJS(data: any): JobApplicationStage {
        data = typeof data === 'object' ? data : {};
...
export class JobSeekerDTO implements IJobSeekerDTO {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.jobId = _data["jobId"];
            this.positionApplied = _data["positionApplied"];
            this.titleId = _data["titleId"];
            this.firstName = _data["firstName"];
            this.lastname = _data["lastname"];
            this.otherName = _data["otherName"];
            ...
            this.yearOfExperience = _data["yearOfExperience"];
            this.availabilityDuration = _data["availabilityDuration"];
            if (Array.isArray(_data["applicationStages"])) {
                this.applicationStages = [] as any;
                for (let item of _data["applicationStages"])
                    this.applicationStages!.push(JobApplicationStage.fromJS(item));
            }
            if (Array.isArray(_data["educations"])) {
                this.educations = [] as any;
                for (let item of _data["educations"])
    ...
    static fromJS(data: any): JobSeekerDTO {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        data["yearOfExperience"] = this.yearOfExperience;
        data["availabilityDuration"] = this.availabilityDuration;
        if (Array.isArray(this.applicationStages)) {
            data["applicationStages"] = [];
            for (let item of this.applicationStages)
                data["applicationStages"].push(item.toJSON());
        }
        if (Array.isArray(this.educations)) {
            data["educations"] = [];
            for (let item of this.educations)
...
export class JobSeekerDTOOdataResult implements IJobSeekerDTOOdataResult {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? JobSeekerDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): JobSeekerDTOOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class ProcessApplicationDTO implements IProcessApplicationDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.selectedApplicantIds = _data["selectedApplicantIds"];
        }
    }

    static fromJS(data: any): ProcessApplicationDTO {
        data = typeof data === 'object' ? data : {};
...
export class ManageArtisanDTO implements IManageArtisanDTO {
    ...
    constructor(data?: IManageArtisanDTO) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    static fromJS(data: any): ManageArtisanDTO {
        data = typeof data === 'object' ? data : {};
...
export class ArtisanDTO implements IArtisanDTO {
    ...
    static fromJS(data: any): ArtisanDTO {
        data = typeof data === 'object' ? data : {};
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(ArtisanDTO.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ArtisanDTOIListOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class ArtisanDTOOdataResult implements IArtisanDTOOdataResult {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? ArtisanDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): ArtisanDTOOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class TrainingDTO implements ITrainingDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.totalCandidates = _data["totalCandidates"];
            this.isActive = _data["isActive"];
            this.durationLength = _data["durationLength"];
            this.startDate = _data["startDate"] ? new Date(_data["startDate"].toString()) : <any>undefined;
            this.endDate = _data["endDate"] ? new Date(_data["endDate"].toString()) : <any>undefined;
            this.datePosted = _data["datePosted"] ? new Date(_data["datePosted"].toString()) : <any>undefined;
            this.dateApproved = _data["dateApproved"] ? new Date(_data["dateApproved"].toString()) : <any>undefined;
            (<any>this).durationLengthName = _data["durationLengthName"];
        }
    }
    ...
    toJSON(data?: any) {
        ...
        data["totalCandidates"] = this.totalCandidates;
        data["isActive"] = this.isActive;
        data["durationLength"] = this.durationLength;
        data["startDate"] = this.startDate ? this.startDate.toISOString() : <any>undefined;
        data["endDate"] = this.endDate ? this.endDate.toISOString() : <any>undefined;
        data["datePosted"] = this.datePosted ? this.datePosted.toISOString() : <any>undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(TrainingDTO.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): TrainingDTOIListOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class TrainingDTOOdataResult implements ITrainingDTOOdataResult {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? TrainingDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): TrainingDTOOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class TrainingApplicantDTO implements ITrainingApplicantDTO {
    ...
    static fromJS(data: any): TrainingApplicantDTO {
        data = typeof data === 'object' ? data : {};
...
export class AppliedApplicantStage implements IAppliedApplicantStage {
    ...
    init(_data?: any) {
        if (_data) {
            this.appliedApplicantId = _data["appliedApplicantId"];
            this.jobId = _data["jobId"];
            this.registeredUserId = _data["registeredUserId"];
            this.recruitmentStageId = _data["recruitmentStageId"];
            this.id = _data["id"];
    ...
    static fromJS(data: any): AppliedApplicantStage {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["appliedApplicantId"] = this.appliedApplicantId;
        data["jobId"] = this.jobId;
        data["registeredUserId"] = this.registeredUserId;
        data["recruitmentStageId"] = this.recruitmentStageId;
        data["id"] = this.id;
...
export class AppliedApplicant implements IAppliedApplicant {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["appliedApplicantStages"])) {
                this.appliedApplicantStages = [] as any;
                for (let item of _data["appliedApplicantStages"])
                    this.appliedApplicantStages!.push(AppliedApplicantStage.fromJS(item));
            }
            this.id = _data["id"];
            this.companyID = _data["companyID"];
            this.subID = _data["subID"];
    ...
    toJSON(data?: any) {
        ...
        if (Array.isArray(this.appliedApplicantStages)) {
            data["appliedApplicantStages"] = [];
            for (let item of this.appliedApplicantStages)
                data["appliedApplicantStages"].push(item.toJSON());
        }
        data["id"] = this.id;
        data["companyID"] = this.companyID;
        data["subID"] = this.subID;
...
export class RegisteredUserResume implements IRegisteredUserResume {
    ...
    static fromJS(data: any): RegisteredUserResume {
        data = typeof data === 'object' ? data : {};
...
export class Company implements ICompany {
    ...
    init(_data?: any) {
        if (_data) {
            this.id = _data["id"];
            this.administratorId = _data["administratorId"];
            this.name = _data["name"];
            this.contactPerson = _data["contactPerson"];
            this.email = _data["email"];
            this.mobile = _data["mobile"];
    ...
    toJSON(data?: any) {
        data = typeof data === 'object' ? data : {};
        data["id"] = this.id;
        data["administratorId"] = this.administratorId;
        data["name"] = this.name;
        data["contactPerson"] = this.contactPerson;
        data["email"] = this.email;
        data["mobile"] = this.mobile;
...
export class RegisteredUser implements IRegisteredUser {
    ...
    availabilityDuration?: number | undefined;
    ...
    briefDescription?: string | undefined;
    isPsychometricTestActive?: boolean | undefined;
    datePsychometricPaid?: Date | undefined;
    countryId?: number | undefined;
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.briefDescription = _data["briefDescription"];
            this.isPsychometricTestActive = _data["isPsychometricTestActive"];
            this.datePsychometricPaid = _data["datePsychometricPaid"] ? new Date(_data["datePsychometricPaid"].toString()) : <any>undefined;
            this.countryId = _data["countryId"];
            ...
            if (Array.isArray(_data["registeredUserResumes"])) {
                this.registeredUserResumes = [] as any;
                for (let item of _data["registeredUserResumes"])
                    this.registeredUserResumes!.push(RegisteredUserResume.fromJS(item));
            }
    ...
    toJSON(data?: any) {
        ...
        data["briefDescription"] = this.briefDescription;
        data["isPsychometricTestActive"] = this.isPsychometricTestActive;
        data["datePsychometricPaid"] = this.datePsychometricPaid ? this.datePsychometricPaid.toISOString() : <any>undefined;
        data["countryId"] = this.countryId;
        ...
        if (Array.isArray(this.registeredUserResumes)) {
            data["registeredUserResumes"] = [];
            for (let item of this.registeredUserResumes)
                data["registeredUserResumes"].push(item.toJSON());
        }
...
export class CvScoreDTO implements ICvScoreDTO {
    ...
    static fromJS(data: any): CvScoreDTO {
        data = typeof data === 'object' ? data : {};
...
export class RezScore implements IRezScore {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.isDeleted = _data["isDeleted"];
            this.isActive = _data["isActive"];
            this.gradeField = _data["gradeField"];
            this.gradeHeadlineField = _data["gradeHeadlineField"];
            this.gradeBlurbField = _data["gradeBlurbField"];
            this.percentileField = _data["percentileField"];
            this.percentileSuffixField = _data["percentileSuffixField"];
            this.normalImgField = _data["normalImgField"];
            this.brevityScoreField = _data["brevityScoreField"];
            this.impactScoreField = _data["impactScoreField"];
            this.depthScoreField = _data["depthScoreField"];
            this.emailField = _data["emailField"];
            this.phoneField = _data["phoneField"];
            this.rezIdField = _data["rezIdField"];
            this.numericIdField = _data["numericIdField"];
            this.adviceShort = _data["adviceShort"];
            this.adviceLong = _data["adviceLong"];
            this.scoreImg = _data["scoreImg"];
            this.scoreImgUrl = _data["scoreImgUrl"];
            this.email = _data["email"];
        }
    }

    static fromJS(data: any): RezScore {
        data = typeof data === 'object' ? data : {};
    ...
    toJSON(data?: any) {
        ...
        data["isDeleted"] = this.isDeleted;
        data["isActive"] = this.isActive;
        data["gradeField"] = this.gradeField;
        data["gradeHeadlineField"] = this.gradeHeadlineField;
        data["gradeBlurbField"] = this.gradeBlurbField;
        data["percentileField"] = this.percentileField;
        data["percentileSuffixField"] = this.percentileSuffixField;
        data["normalImgField"] = this.normalImgField;
        data["brevityScoreField"] = this.brevityScoreField;
        data["impactScoreField"] = this.impactScoreField;
        data["depthScoreField"] = this.depthScoreField;
        data["emailField"] = this.emailField;
        data["phoneField"] = this.phoneField;
        data["rezIdField"] = this.rezIdField;
        data["numericIdField"] = this.numericIdField;
        data["adviceShort"] = this.adviceShort;
        data["adviceLong"] = this.adviceLong;
        data["scoreImg"] = this.scoreImg;
...
export class RezScoreApiResult implements IRezScoreApiResult {
    ...
    init(_data?: any) {
        if (_data) {
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.result = _data["result"] ? RezScore.fromJS(_data["result"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
            (<any>this).totalRecord = _data["totalRecord"];
        }
    }

    static fromJS(data: any): RezScoreApiResult {
        data = typeof data === 'object' ? data : {};
...
export class EmployerDTO implements IEmployerDTO {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.firstName = _data["firstName"];
            this.lastName = _data["lastName"];
            (<any>this).administrator = _data["administrator"];
            this.accountTypeId = _data["accountTypeId"];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(EmployerDTO.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): EmployerDTOIListOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class EmployerDTOOdataResult implements IEmployerDTOOdataResult {
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.hasError = _data["hasError"];
            this.message = _data["message"];
            this.value = _data["value"] ? EmployerDTO.fromJS(_data["value"]) : <any>undefined;
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): EmployerDTOOdataResult {
        data = typeof data === 'object' ? data : {};
...
export class SubscriptionPaymentIListOdataResult implements ISubscriptionPaymentIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: SubscriptionPayment[] | undefined;
    totalCount?: number;

    constructor(data?: ISubscriptionPaymentIListOdataResult) {
        if (data) {
            for (var property in data) {
                if (data.hasOwnProperty(property))
                    (<any>this)[property] = (<any>data)[property];
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(SubscriptionPayment.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): SubscriptionPaymentIListOdataResult {
        data = typeof data === 'object' ? data : {};
        let result = new SubscriptionPaymentIListOdataResult();
        result.init(data);
        return result;
    }
...
export interface ISubscriptionPaymentIListOdataResult {
    id?: number;
    hasError?: boolean;
    message?: string | undefined;
    value?: SubscriptionPayment[] | undefined;
...
export class SubscriptionPlanFeatureDTO implements ISubscriptionPlanFeatureDTO {
    ...
    static fromJS(data: any): SubscriptionPlanFeatureDTO {
        data = typeof data === 'object' ? data : {};
        ...
        if (_data) {
            ...
            if (Array.isArray(_data["plans"])) {
                ...
                for (let item of _data["plans"])
                    this.plans!.push(SubscriptionPlanFeatureDTO.fromJS(item));
            }
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            if (Array.isArray(_data["value"])) {
                this.value = [] as any;
                for (let item of _data["value"])
                    this.value!.push(SubscriptionFeatureDTO.fromJS(item));
            }
            this.totalCount = _data["totalCount"];
        }
    }

    static fromJS(data: any): SubscriptionFeatureDTOIListOdataResult {
        data = typeof data === 'object' ? data : {};
